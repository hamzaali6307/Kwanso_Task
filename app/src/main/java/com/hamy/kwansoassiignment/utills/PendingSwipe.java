...
public class PendingSwipe extends ItemTouchHelper.SimpleCallback
{
	private final OnPendingSwipeListener listener;
	...
	public PendingSwipe(int dragDirs, int swipeDirs, Context context, OnPendingSwipeListener listener) {
	...
	public void onChildDraw(@NonNull Canvas canvas, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive)
	{
		...
		Drawable deleteIcon = ContextCompat.getDrawable(context, R.drawable.ic_baseline_error_outline_24);
	...
	public interface OnPendingSwipeListener {
